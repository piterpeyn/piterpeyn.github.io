...
<html lang="ru">
<head>
    <title>OOPS! Choice Awards 2017?</title>
    <meta charset="utf-8">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-10 col-md-offset-1 side-pad-20">
                <div class="nomination-page-title">
                    ...
                    <div>
                        <h1 class="nomination-category-name">Ваш голос обрабатывается.</h1>
                        <h2 class="nomination-name">Это делается для того, чтобы результаты не обманывались и не взламывались.</h2>
                    </div>
                </div>
            </div>
        </div>
