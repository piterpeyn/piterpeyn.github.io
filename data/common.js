...
function onDocumentClick(e) {
  ...
  path = path[1];
  if (path.indexOf('.php') > 0 || /*path.indexOf('/') > 0 || */path.match(/^(doc\-?\d+_\d+|graffiti\d+|reg\d+|images|utils|\.js|js\/|\.css|css\/|source)/)) {
    return true;
  }
  try {
    nav.go(href, e, opts);
...
var nav = {
  ...
  go: function(loc, ev, opts) {
    ...
    var done = function(title, html, js, params) {
      ...
      if ((stVersions['common.js'] / 10) > (StaticFiles['common.js'].v) / 10) {
...
function MessageBox(options, dark) {
  ...
  boxContainer = ce('div', {
    className: 'popup_box_container'+(dark ? ' box_dark' : ''),
    innerHTML: '\
<div class="box_layout" onclick="__bq.skip=true;">\
<div class="box_title_wrap"><div class="box_x_button">'+(dark ? getLang('global_close') : '')+'</div><div class="box_title"></div></div>\
